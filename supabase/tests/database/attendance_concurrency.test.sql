...
select extensions.dblink_connect('membership_one','dbname=postgres user=postgres password=postgres');
select extensions.dblink_connect('membership_two','dbname=postgres user=postgres password=postgres');
...
select extensions.dblink_connect('scan_one','dbname=postgres user=postgres password=postgres');
select extensions.dblink_connect('scan_two','dbname=postgres user=postgres password=postgres');
