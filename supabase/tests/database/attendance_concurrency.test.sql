...
select extensions.dblink_connect('membership_one','host=127.0.0.1 dbname=postgres user=postgres password=postgres');
select extensions.dblink_connect('membership_two','host=127.0.0.1 dbname=postgres user=postgres password=postgres');
...
select extensions.dblink_connect('scan_one','host=127.0.0.1 dbname=postgres user=postgres password=postgres');
select extensions.dblink_connect('scan_two','host=127.0.0.1 dbname=postgres user=postgres password=postgres');
